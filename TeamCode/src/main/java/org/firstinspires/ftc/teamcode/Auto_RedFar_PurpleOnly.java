...
@Autonomous(name = "Auto - Red FarFarAway - [Purple Only]", group = "Match")
public class Auto_RedFar_PurpleOnly extends LinearOpMode {
    public String workingMode = "redfar_purpleonly";
