...
@Autonomous(name = "Auto - Blue FarFarAway - [Purple Only]", group = "Match")
public class Auto_BlueFar_PurpleOnly extends LinearOpMode {
    public String workingMode = "bluefar_purpleonly";
